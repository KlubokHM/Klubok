...
<body>
<div class="container">
    <h4 class="mt-3 text-center"><a href="{{route('moderator.index')}}">Панель Учреждения</a></h4>
    <nav class="navbar mt-3 navbar-expand-lg navbar-dark bg-dark justify-content-between">
        <ul class="navbar-nav justify-content-start">

            <li class="nav-item ml-3">
                <a class="nav-link text-light" href="{{route('moderator.products.index')}}">Товары</a>
            </li>
            <li class="nav-item ml-3">
                <a class="nav-link text-light" href="{{route('moderator.category.index')}}">Категории</a>
            </li>
            <li class="nav-item ml-3">
                <a class="nav-link text-light" href="#">Мастерклассы</a>
            </li>
            <li class="nav-item ml-3">
                <a class="nav-link text-light" href="{{route('admin.statements')}}">Заявки</a>
            </li>
        </ul>
